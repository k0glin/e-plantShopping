...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Gustavo`s Plants, where green meets serenity!</p>
      <p className="about-us-content">
        At Gustavo`s Plants, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of
